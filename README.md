...
<img src="https://github.com/daenuprobst/minf/blob/main/assets/anim.gif?raw=true"><br><br>
Alternatively, view the file here:<br>
...
`minf` is distributed under the terms of the [MIT](https://spdx.org/licenses/MIT.html) license.
